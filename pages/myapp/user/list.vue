<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="user_name,password,phone,register_time,area,role_id,email" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'phone')" sortable @sort-change="sortChange($event, 'phone')">电话</uni-th>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'area')" sortable @sort-change="sortChange($event, 'area')">所在地区</uni-th>
            <uni-th align="center" filter-type="select" :filter-data="options.filterData.role_id_localdata" @filter-change="filterChange($event, 'role_id')">角色id</uni-th>
