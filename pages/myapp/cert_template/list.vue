<template>
	<view>
		...
		<view class="uni-container">
			<unicloud-db ref="udb" :collection="collectionList" field="_id,name,image" :where="where"
				...
				<uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe
					...
					<uni-tr>
						<uni-th align="center">模板id</uni-th>
						<uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'name')"
							sortable @sort-change="sortChange($event, 'name')">模板名称</uni-th>
						<uni-th align="center" sortable @sort-change="sortChange($event, 'image')">背景图片</uni-th>
...
<script>
	import {
		enumConverter,
		filterToWhere
	} from '@/js_sdk/validator/cert_template.js';
	...
	export default {
		...
		onReady() {
			...
			console.log(this.$refs.udb.$data)
		},
		methods: {
			onqueryload(data) {
